<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
      ...
      <el-table-column prop="orderComment" header-align="center" align="center" label="订单备注"></el-table-column>
      ...
      <el-table-column prop="orderBody" header-align="center" align="center" label="订单描述"></el-table-column>
      <el-table-column prop="trackingNo" header-align="center" align="center" label="物流单号"></el-table-column>
      ...
      <el-table-column prop="taskComment" header-align="center" align="center" label="工作单备注"></el-table-column>
...
<script>
import AddOrUpdate from './ware-task-add-or-update'
